...
const blogContent: any = {
  posts: (() => {
    const defaultBlogPosts = [
      {
        title:
          "DEFAULT: How to Choose the Right Porta Potty Type for Your Event",
        metaTitle:
          "DEFAULT: How to Choose the Right Porta Potty Type for Your Event in [location]",
        metaDescription:
          "DEFAULT: Learn how to choose the perfect porta potty type for your event or construction project in [location]. Expert tips and facility guide.",
        category: "DEFAULT: porta-potty-selection",
        categoryName: "DEFAULT: Porta Potty Selection",
        slug: "DEFAULT: choose-porta-potty-type",
        h1: "DEFAULT: How to Choose the Right Porta Potty Type for Your Event",
        description:
          "DEFAULT: Selecting the right porta potty type can make your event or project run smoothly and keep everyone comfortable.",
        postImageSrc:
          "https://ik.imagekit.io/h7rza8886p/Default1.jpg?updatedAt=1757319001930",
        postImageAlt: "DEFAULT: porta potty rental selection guide",
        publishedAt: "DEFAULT: 2025-01-01",
        body: "DEFAULT: <p>Choosing the right porta potty type is crucial for any event or construction project. This comprehensive guide will help you select the perfect facilities for your needs in [location].</p>",
      },
    ];
    ...
    return blogDataJson.map((post: any, index: number) => {
      ...
      const baseFallback = {
        title: "DEFAULT: Porta Potty Rental Tips",
        metaTitle: "DEFAULT: Porta Potty Rental Information",
        metaDescription: "DEFAULT: Learn about porta potty rental in [location].",
        category: "DEFAULT: general",
        categoryName: "DEFAULT: General",
        slug: `DEFAULT: blog-post-${index + 1}`,
        h1: "DEFAULT: Porta Potty Rental Blog Post",
        description: "DEFAULT: Helpful information about porta potty rental.",
        postImageSrc: "https://ik.imagekit.io/h7rza8886p/Default1.jpg?updatedAt=1757319001930",
        postImageAlt: "DEFAULT: blog post image",
        publishedAt: "DEFAULT: 2025-01-01",
        body: "DEFAULT: <p>Blog content about porta potty rental services.</p>"
      };
...
const blogCategoryMetaMap: any = (() => {
  const defaultCategoryMetas = {
    "DEFAULT: general": {
      title:
        "DEFAULT: Porta Potty Rental Tips and Information | [location] Insights",
      description:
        "DEFAULT: Discover helpful tips and insights about porta potty rental services in [location]. Expert advice for your events and projects.",
      bannerImage:
        "https://ik.imagekit.io/h7rza8886p/Default1.jpg?updatedAt=1757319001930",
    },
  };
